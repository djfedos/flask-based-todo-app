describe('root page', () => {
  it('todo_app_is_up', () => {
    cy.visit('http://192.168.1.20:5000')
...
describe('login, add, edit task', () => {
  it('function test', () => {
    cy.visit('http://192.168.1.20:5000/register')
    ...
    cy.visit('http://192.168.1.20:5000/login')
    ...
    cy.visit('http://192.168.1.20:5000/edit_task/1')
